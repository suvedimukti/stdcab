...
[![Travis build status](https://travis-ci.com/suvedimukti/stdcab.svg?branch=master)](https://travis-ci.com/suvedimukti/stdcab)
<!-- badges: end -->
...
`Analysis` or Training and Assessment or Testing set in each fold and repeats.
