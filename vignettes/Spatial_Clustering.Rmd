...
vignette: >
  %\VignetteIndexEntry{Spatial Clustering of Point Data For Machine Learning in Tidy-modeling}
...
Now we can create a dataframe from the list of `splits`
```{r dft}
...
Now we have fold and training and testing data for each fold, we can visualize
folds using ggplot2

```{r visualize,fig.width = 10, fig.height = 8}
